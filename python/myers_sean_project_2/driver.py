...
version = 0
wins = 0
wins += play("checkers2","checkers")
#play("checkers","???checkers")
#play("???checkers","checkers")

wins += play("checkers2","checkers",start_state = Test_Board1)
wins += play("checkers2","checkers",start_state = Test_Board2)
wins += play("checkers2","checkers",start_state = Test_Board3)
