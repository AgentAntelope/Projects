package Lab7;
// CS 401 Fall 2009 Lab 7 Main Program
...
public class Lab7
{
	...
	public static void loadData(MovieDB movies) throws IOException
	{
		...
		Movie[] theMovie = new Movie[numTimes];
		...
		theMovie[i] = new Movie(Title, Director, Studio, Gross);
		movies.addMovie(theMovie[i]);
		}
		// *** CODE SEGMENT 1 *** //
	...
	public static void getCommands(MovieDB movies)
	{
		...
		while (true)
		{
			...
			{
				System.out.println("Enter a movie you want to find");
				String Finder = inScan.nextLine();
