package Handouts;
/* CS 0401 Fall 2009 Java Example 3
 * This handout demonstrates the Scanner class and how it can be used
 * Important Note:  The Scanner class was introduced in Java 5.0 (1.5) so
 *		it will not be accessible in any versions before that.  If you
 *		compile this program and get a "cannot resolve symbol" error for
 *		the Scanner declaration, it is probably because you are not using
 *		Java 5.0.
 *
...
import java.util.*; // Make Scanner class accessible.  The import
	...
	// see: http://java.sun.com/docs/books/tutorial/java/package/index.html
