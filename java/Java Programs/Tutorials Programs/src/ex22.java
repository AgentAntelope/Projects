...
// same class names with the letter T behind them: ex22T.java, SortAllT.java
...
public class ex22
{
	...
	public static void main(String [] args)
	{
		...
		// Below is code coped from the CDTest handout.  Now I am using
		// the compareTo method that I told you not to worry about when
		// we first discussed the CD class.  Note also that had I so chosen, 
		// I could have defined compareTo in the CD class to compare by any 
		...
		// be explicitly handled in the program.  In the CDTest program, I
