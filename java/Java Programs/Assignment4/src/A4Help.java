...
public class A4Help
{
	...
	public A4Help()
	{
		...
		thePane.add(buttonPanel, BorderLayout.NORTH);
		thePane.add(drawPanel, BorderLayout.CENTER);
	...
	class MyListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				int sz = R.nextInt(80);
				int x = R.nextInt(drawPanel.getWidth());
				int y = R.nextInt(drawPanel.getHeight());
